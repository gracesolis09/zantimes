...
function block_categories( $categories ) {
	...
	foreach( $categories as $category ) {
		if( 'zantimes-blocks' === $category['slug'] ) {
			$include = false;
		}
	}
...
add_action('init', function() {
	register_block_style('core/paragraph',
		[
			'name' => 'tagline',
			'label' => __('Tagline', 'zantimes'),
		]
	);

	register_block_style('core/heading',
		[
			'name' => 'heading-w-border-line',
			'label' => __('With Border Line', 'zantimes'),
		]
	);
	...
	register_block_style('core/button',
		[
			'name' => 'btn-primary',
			'label' => __('Purple Button', 'zantimes'),
		]
	);
	...
	register_block_style('core/group',
		[
			'name' => 'w-wave-element',
			'label' => __('W/ Wave Element', 'zantimes'),
		]
	);
	...
	register_block_style('core/group',
		[
			'name' => 'higher-z-index',
			'label' => __('Higher z-index', 'zantimes'),
		]
	);
});
